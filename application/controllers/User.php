...
class User extends CI_Controller
{
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">User Has created !</div>');
            redirect('user/list');
        }
    }
    ...
    public function forward()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->db->set('is_active', $b);
            $this->db->set('divisi', $div);
            $this->db->where('id', $id);
            $this->db->update('user');
    ...
    public function list()
    {
            ...
            $data['d'] = $this->db->get('user')->result_array();
            $data['list'] = $this->db->get('problem_req')->result_array();
